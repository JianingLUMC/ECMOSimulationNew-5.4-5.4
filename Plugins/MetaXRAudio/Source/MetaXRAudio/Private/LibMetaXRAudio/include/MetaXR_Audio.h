...
#define OVR_AUDIO_MINOR_VERSION 103
...
typedef enum {
  ...
  ovrAudioEnable_Diffraction = 6, ///< Enable Diffraction. Default: disabled
...
typedef enum {
  ...
  ovrAudioAcousticModel_PropagationSystem = 3, ///< Sound propgated using game geometry
...
typedef enum {
  ...
  ovrAudioMaterialPreset_MetaDefault,
...
inline ovrResult ovrAudio_GetReflectionBands(ovrAudioMaterialPreset Preset, ovrAudioBands Bands) {
  ...
  switch (Preset) {
    ...
    case ovrAudioMaterialPreset_WoodOnConcrete:
      ...
      Bands[3] = 0.930052698f;
      break;
    case ovrAudioMaterialPreset_MetaDefault:
      Bands[0] = 0.9f;
      Bands[1] = 0.9f;
      Bands[2] = 0.9f;
      Bands[3] = 0.9f;
